...
export default function AboutUs() {
    return (
        <>
            <div
                className="min-h-[70vh] w-full bg-secondary"
                style={{
            ...
            >
                <div className="container mx-auto pt-10 md:pt-20 px-5 md:px-10 lg:px-25 xl:px-35 relative">
                    ...
                    <div className="hidden md:block">
                        <div className="absolute right-15 -bottom-120">
                    ...
                    <div className=" md:hidden w-full flex justify-center">
                        <div className="bg-primary p-5 flex flex-col justify-center gap-3 w-full max-w-md rounded-lg shadow-lg mt-10 mb-5">
