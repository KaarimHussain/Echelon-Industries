import HeroImage from "@/assets/imgs/OurProjects/hero.png";
                    ...
                    >
                        <div className="flex flex-col items-start justify-center h-full gap-5">
                            <h1 className="text-start font-bold uppercase text-3xl sm:text-4xl md:text-5xl text-primary-foreground font-montserrat leading-tight">
                                ...
                                Across {" "}
                                <span className="underline underline-offset-4 decoration-primary font-montserrat decoration-[6px] sm:decoration-[8px] md:decoration-[10px]">Every</span> <br />
                                Project
                            </h1>
                            <p className="text-lg text-primary-foreground">
                                Explore our portfolio of successful projects spanning multiple industries and scales.<br />
                                See how Echelon Industries transforms vision into reality with expertise and commitment.
                            </p>
