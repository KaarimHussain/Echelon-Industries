                ...
                <div className="relative z-10 h-[85vh] px-5 md:px-10 grid lg:grid-cols-2 grid-cols-1 items-center justify-between">
                    ...
                    >
                        <motion.h1 
                            ...
                            className="text-start font-bold uppercase text-3xl sm:text-4xl md:text-5xl text-primary-foreground font-montserrat leading-tight"
                        >
                    ...
                    <motion.div 
                        ...
                        className=" lg:flex items-center justify-end hidden "
                    >
